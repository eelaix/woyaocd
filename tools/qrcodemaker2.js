...
var pc_thechargerid = 100120;  //要生成的二维码起始编号
var pc_lastchargerid = 100123; //要生成的二维码结束编号
...
var pc_postbody = {'path':'xmain/evcar?chgid=100120','width':430};
...
var pc_downloadimage = function () {
    pc_postbody.path = '/pages/evcar?chid=' + pc_thechargerid + '';
